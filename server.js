...
/***/ function(module, exports, __webpack_require__) {
	...
	var FootballDataServer = function () {
	    function FootballDataServer() {
	        _classCallCheck(this, FootballDataServer);

	        this.app = (0, _express2.default)();
	    }

	    _createClass(FootballDataServer, [{
	        key: 'serve',
	    ...
	    return FootballDataServer;
	}();

	var server = new FootballDataServer();
	server.serve();
